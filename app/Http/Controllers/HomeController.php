...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $operator=Operator::select('id')->where('user_id', $userId)->get()->toArray();

        $assets = ['chart', 'animation'];

        return view('dashboards.dashboard', compact('assets','operator'));
    }
    ...
    // {
    //     $choice= $request->ustAcheckBox;

    //     // return view('forms.wizard');
    //     // return view('forms.wizard', compact('choice'));
    //     // return redirect()->back()->with('choice',$choice);
    //     // return view('forms.wizard', ['choice' => 'choice']);
    ...
    public function wizard(Request $request)
    {
        $choice= $request->input('ustAcheckBox');
        return view('forms.wizard', compact('choice'));
    }
