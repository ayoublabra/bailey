                            ...
                            @if($contract->company_id == 105)
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="departement_naissance" id="nom_naissance" oninput="this.value = this.value.toUpperCase()" value="{{ $contract->nom_naissance }}"/>
                                    </div>
                                 </div>
                            @endif
