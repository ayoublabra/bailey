                                             ...
                                             <div class="modal-body">
                                                ...
                                                <!-- {{count($us->operators)}} -->
                                                 ...
                                                 @endif
                                                   ...
                                                   {{-- <div  id="div_for_conseiller_update{{$us->id}}">
                                                      <label id="label_che" class="form-label" >Choisissez les type de contrat qui peut saisir:</label>
                                                      
                                                      @foreach ($companys as $item)
                                                         @php
                                                            $isChecked = false;
                                                            foreach ($us->operator_access as $acces) {
                                                                  if ($item->id == $acces->company_id && $item->active == 1) {
                                                                     $isChecked = true;
                                                                     break;
                                                                  }
                                                            }
