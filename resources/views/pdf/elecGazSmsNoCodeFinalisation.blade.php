...
<body>
    ...
    <main style="padding:8px !important">
        ...
        <ul>
            ...
            Souhaitez-vous vous prémunir financièrement en cas de de licenciement économique, cessation d’activité suite à un dépôt de bilan, affectation longue durée (ALD 30 ou ALD 32) ou hospitalisation ?  &nbsp; {{new Illuminate\Support\HtmlString($checkfinancementicon2)}}</p>
            ...
            <tbody>
                <tr>
                    <td align="center" style="width:10cm;">
                        ...
                        @if(!empty($textselected2))
                            @foreach ($textselected2 as $article)
                                <div> &nbsp; &nbsp;&nbsp; &nbsp;<label>
