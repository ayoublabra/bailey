...
<style>
    ...
    .bg {
        background-image: url("./images/pages/pge3.jpg");
        height: 100%; 
    ...
    .bd{
        background-image: url("./images/pages/pge4.jpg");
        height: 100%; 
        background-position: center;
        background-repeat: no-repeat;
        background-size: cover;
    ...
    .bh{
        background-image: url("./images/pages/pge1.jpg");
        height: 100%; 
        background-position: center;
        background-repeat: no-repeat;
        background-size: cover;
    ...
    .bn{
        background-image: url("./images/pages/pge2.jpg");
        height: 100%; 
        background-position: center;
        background-repeat: no-repeat;
        background-size: cover;
...
<body>
    ...
    <main style="padding:8px !important">
        ...
        <h2 class="txt-cntr" id="title">{{ $title2 }}</h2>
        ...
        <div class="box">
            <span class="boxleft">Nom : </span> <span class="inputs">{{ $fname2 }}</span>&nbsp; &nbsp;
            <span class="boxleft">Prénom : </span> <span class="inputs">{{ $lname2 }}</span>&nbsp; &nbsp;
            <span class="boxleft">Date de naissance : </span> <span class="inputs">{{ $datebird2 }}</span>&nbsp; &nbsp;
            <span class="boxleft">Adresse: </span> <span class="inputs">{{ $adresse2  }}</span>&nbsp; &nbsp;
            <span class="boxleft">Ville : </span> <span class="inputs">{{ $city2 }}</span>&nbsp; &nbsp;
            <span class="boxleft">CP : </span> <span class="inputs">{{ $cp2 }}</span>&nbsp; &nbsp;
            <span class="boxleft">Mail : </span> <span class="inputs">{{ $mail2 }}</span>&nbsp; &nbsp;
            <span class="boxleft">Tel : </span> <span class="inputs">{{ $phone2 }}</span>
        </div>
        ...
        et / ou de disfonctionnement de votre chaudière, chauffe-eau ou chauffe-bain ?  &nbsp; {{new Illuminate\Support\HtmlString($checkfinancementicon2)}} </p>

        <p>Etes-vous assurés contre ce type de risques ? &nbsp; {{new Illuminate\Support\HtmlString($checkrisqueicon2)}}</p>

        <p>Dans l’affirmative, souhaitez-vous changer de produit et d’assureur ? &nbsp; {{new Illuminate\Support\HtmlString($checkproducticon2)}}</p>

        <p>Remarques : {{ $comment2 }}</p>
        ...
        immatriculée au registre du Commerce et des Sociétés de Paris sous le n° 775 670 466.</p>
        <p>Ce contrat vous permet la prise en charge, à hauteur du forfait énoncé, de vos frais de réparation en cas de 1/ fuite d’eau intérieure ou extérieure
        ...
        <p class="sncs">Il sera accusé réception de votre réclamation dans les 48h et le maximum sera fait pour vous apporter une réponse dans un délai maximal de deux mois.</p>
        ...
        <div>
            ...
            et à la communication de ces données après votre décès.</p>
            <p>Vous pouvez exercer ces droits en nous adressant un courrier accompagné d’une pièce d’identité recto-verso à Bailey Assurances, Service client — BAILEY
        ...
        <br/>
        <div class="box">
            <div class="boxleft">Fait à : {{ $city2 }}</div>
            <div class="boxleft">Le : {{ $date2 }}</div>
        ...
        <div class="container" style="font-size:10px !important;">
            <div class="table-row">
                <div class="table-cell1">
                    ...
                    <u class="bold">Notice d’information du contrat n° 01049859</u>
            ...
            <div class="table-row">
                <div class="table-cell1">           
                       ...
                       <u>Circuit d’alimentation d’eau</u>
                        ...
                        o EN CAS DE SINSITRE CAUSE OU PROVOQUE INTENTIONNELLEMENT PAR L’ASSURE OU LE BENEFICIAIRE DU PRESENT CONTRAT,<br/>
        ...
        <table style="width:20cm;font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:10px;">
            <tbody>
                <tr>
                    ...
                    <td align="center" style="width:10cm;">
                        <p><span>Nom du Client : {{ $fname2 }} {{ $lname2 }}</span></p>
                        <p><span>Adresse : {{ $adresse2  }}</span></p>
                        <p><span>Code Postal : {{ $cp2 }}</span> <span>Ville : {{ $city2 }}</span></p>
                        <p><span>Date contrat : {{ $date2 }}</span></p>
