...
<body>
    ...
    <main>
        <div><img src="./images/pages/emass1.jpg" width="700px" height="1000px"></div>
        <div><img src="./images/pages/emass2.jpg" width="700px" height="1000px"></div>
        <h2 class="txt-cntr" id="title">{{ $title }}</h2>
        <p class="txt-cntr txt-tp">Le présent document est établi préalablement à la conclusion d’un contrat d’assurance. Il nous permet de vous communiquer les informations réglementaires
        ...
        <div class="container" style="font-size:10px !important;">
            <div class="table-row">
                ...
                <div class="table-cell1">
                    ...
                    de la Garantie et sont nécessaires pour les traitements informatiques liés à la gestion de son contrat
                    d’assurance et peuvent être également utilisées, sauf opposition de sa part, à des fins commerciales.
        ...
        <br/>
        <hr class="new3">      
        <div classs="txt-cntr bold">FORMULAIRE DE RETRACTATION</div>
            ...
            <tbody>
                <tr>
                    <td align="center" style="width:8cm;">
                        ...
                        <label class="checkbox-label bold">Option Électricité</label>
                        <input type="checkbox" class="chx">
                        <label class="checkbox-label bold">Option Gaz</label>                           
        ...
        <div><img src="./images/pages/emass3.jpg" width="620px" height="1000px"></div>
        <div ><img src="./images/pages/emass4.jpg" width="620px" height="1000px"></div>
            ...
            <tbody>
                <tr>
                    <td align="center" style="width:4cm;">
                        ...
                        <p class="txtgray bold">factures*</p>
                        <p class="txtgray bold">DEMANDE D’ADHESION</p>
                    </td>
                    <td align="center" style="width:8cm;">
                        <img src="./images/pages/assurance.jpg" width="160px" height="80px">
                    </td>
                    <td align="center" style="width:4cm;">
                        <p><span class="topdiv bold">0 970 17 27 52</span></p>
                        <p><span class="txtblue bold">Prix d’un appel local</span></p>
                        <p><span class="txtgray bold">contact@monassurancefacture.fr</span></p>
        ...
        <div class="box radiudiv">
            <p class="bold txt-cntr"> Coordonnées du/des titulaire(s) du contrat </p>
            <p>
                <input type="checkbox" class="chx">
            ...
            <span class="boxleft bold">Code postal : </span> <span class="inputs">{{ $city }}</span>&nbsp; &nbsp;
            <span class="boxleft bold">Ville : </span> <span class="inputs">{{ $cp }}</span>&nbsp; &nbsp;
            ...
            <input type="checkbox" class="chx">
            <label class="checkbox-label bold">Option ÉLECTRICITÉ : PDL &nbsp; &nbsp;&nbsp; &nbsp; Fournisseur :</label>
            </br>
            <input type="checkbox" class="chx">
            <label class="checkbox-label bold">Option GAZ : PCE  &nbsp; &nbsp;&nbsp; &nbsp; Fournisseur :</label>
        </div>
        ...
        <div class="box radiudiv">
            ...
            <p>
                <input type="checkbox" class="chx">
                <label class="checkbox-label bold">LES GARANTIES SOUSCRITES : L’assuré, à jour de ses cotisations, béneficie d’une prise en charge du paiement des factures* suite à la
                réalisation de l’un des risques suivants, mentionnés dans la notice d’information du contrat N° LPASPH 001 : </label>
                ...
                * L’assureur prends en charge 12 mois de factures de téléphonie, internet, assurance et énergétique (éléctricité et/ou gaz, bois, fuel, etc), dans la
                ...
                la limite de 200 € par événement et par année (factures de téléphonie, internet, assurance et énergétique, ménage, jardinage, transport etc...)</p>
                <input type="checkbox" class="chx">
                <label class="checkbox-label">Je reconnais avoir reçu lors de l’adhésion la fiche IPID, la notice d’information valant condition générale et avoir répondu en toute sincérité à la
                fiche d’information et de conseil.</label>
            </p>      
        </div>
        ...
        <div class="box radiudiv">
            ...
            Je reconnais avoir reçu et pris connaissance des principales dispositions du contrat collectif n° LPASPH001 et je demande à adhérer à ce contrat.
            ...
            Je confirme ma souscription aux garanties de prise en charge du paiement des factures* moyennant un abonnement</span> 
            <span class="bold">de 7,90 € TTC par mois par option d’énergie, avec un engagement de 12 mois, renouvelable par tacite reconduction.</span></p>   
            <p><span class="bold">Fait à : </span><span class="bold">Signature :</span> <span class="bold">Le : </span></p>
        </div>
        <div class="box radiudiv">
            <p class="bold">ASSUREUR : Contrat souscrit par SPHINX AFFINITY auprès de Wakam S.A. (120-122 Rue Réaumur 75002 PARIS-SA au capital de 4 514 512,00 € Siren 562 117 085 - APE 6512Z), distribué par
            l’INTERMEDIAIRE D’ASSURANCE : BAILEY ASSURANCES N° Orias : 18004781 SIREN 820 472 553 RCS Caen - Louvigny 14111, 9 chemin des carreaux. </p>    
            <p class="bold">Entreprises régie par le code des assurances et soumises à l’Autorité de Contrôle Prudentiel et de Résolution (A.C.P.R) 4 place de Budapest, CS 92459 - 75009 PARIS.</p>   
        </div>
        <div class="box radiudiv">
                    ...
                    <tr>
                        <td align="center" style="width:4cm;">
                            <div class="box styledzone">
                                <p><span  class="txtgray">Nom du Créancier</span><br/><span class="bold">BAILEY ASSURANCES MON ASSURANCE FACTURE</span></p>
                                ...
                                <input type="checkbox" class="chx">
                                <label class="checkbox-label bold">10 </label>                            
                            </div>
                        </td>
